...
const styles = StyleSheet.create({
  ...
  statCard: {
    ...
    width: screenType !== 'mobile' ? responsiveValue(180, 200, 220) : undefined,
    minWidth: screenType === 'mobile' ? 70 : undefined,
    backgroundColor: Colors.secondary.bg,
    borderRadius: 12,
    padding: getResponsivePadding(15),
    alignItems: "center",
    marginHorizontal: responsiveValue(4, 6, 8),
  ...
  featureCard: {
    ...
    borderWidth: 1,
    borderColor: Colors.card.border,
    width: screenType !== 'mobile' ? responsiveValue('48%', '48%', '48%') as any : undefined,
    maxWidth: screenType !== 'mobile' ? responsiveValue(380, 420, 480) : undefined,
  },
  featureTitle: {
